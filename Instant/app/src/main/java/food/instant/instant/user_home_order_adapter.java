...
public class user_home_order_adapter extends BaseAdapter {
    private ArrayList<Order> orders;
    private Context context;
    private user_home_order fragment;
    public user_home_order_adapter(Context context, ArrayList<Order> orders, user_home_order fragment){
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (orders.size() == 1) {
                        ...
                        ((MainActivity) context).swapFragments(new user_home());
                    } else {
                        orders.remove(orders.get(i));
                    }
                    ((user_home_order_adapter) view.getTag()).notifyDataSetChanged();
