...
public class user_home_orders_adapter extends BaseAdapter {
    private ArrayList<ArrayList<Order>> orders;
    private Context context;
    public user_home_orders_adapter(Context context,ArrayList<ArrayList<Order>> orders){
        ...
        if(orders.size()!=0) {
            ...
            orderStatus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MainActivity) context).swapFragments(new user_home_order((ArrayList<Order>) view.getTag()));
                }
            });
        }
        return view;
