...
public class Order {
    ...
    public Order(int Order_ID,int User_ID, Food food,String comments,int Food_Quantity, String Restaurant_Name,char status, int Dummy_PK, int Order_Confirmation_Code, String date_submitted, String date_pickedUp, String user_first_name, String user_last_name, String user_email)
    {
